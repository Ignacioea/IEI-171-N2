USE iei-171-n2
"""
SCRIPTS PARA CREAR LAS TABLAS DE LA BASE DE DATOS
COPIAR LOS SCRIPTS DESDE LA LINEA 6 EN ADELANTE
"""
...
CREATE TABLE IF NOT EXISTS BIBLIOTECA(
    ...
    CONSTRAINT fk_biblioteca_libro FOREIGN KEY(id_libro) REFERENCES LIBRO(id)
);
