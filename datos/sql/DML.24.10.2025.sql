...
INSERT INTO libro (titulo, editorial, anio_publicacion, categoria, ISBN, id_autor) 
VALUES
('Object-Oriented Programming in C++', 'Pearson', 2013, 'Programación', '9780672323089', 1),
('Computer Networks', 'Pearson', '2011', 'Redes', '9780132126953', 2),
('Los 7 hábitos de la gente altamente efectiva', 'Paidos', 2013, 'Administración', '9788497594250', 3),
('The Art of Electronics', 'Cambridge University Press', 2015, 'Electrónica', '9780521809269', 4),
('The Design of Everyday Things', 'Basic Books', 2013, 'Diseño', '9780465050659', 5),
('Internetworking with TCP/IP', 'Pearson', 2013, 'Redes', '9780136085300', 6),
('Starting Out with Python', 'Pearson', 2020, 'Programación', '9780135929032', 7),
('Start With Why', 'Penguin Books', 2011, 'Administración', '9781591846444', 8),
('English Grammar in Use', 'Cambridge University Press', 2019, 'Inglés', '9781108457651', 9),
('Computer Networking: A Top-Down Approach', 'Pearson', 2017, 'Redes', '9780133594140', 10),
('Python Programming: An Introduction to Computer Science', 'Franklin, Beedle & Associates', 2016, 'Programación', '9781590282755', 7),
('Human-Centered Design', 'CRC Press', 2019, 'Diseño', '9781498764378', 5),
('Effective Leadership', 'Penguin Books', 2017, 'Administración', '9780241970058', 8),
('Electronic Principles', 'McGraw-Hill', 2016, 'Electrónica', '9781259250995', 4),
('Practical Electronics for Inventors', 'McGraw-Hill', 2016, 'Electrónica', '9781259587541', 4);

INSERT INTO biblioteca (ubicacion, telefono_contacto, correo_contacto, horario_atencion, id_sede, id_libro) 
VALUES
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 1),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 2),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 3),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 4),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 5),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 6),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 7),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 8),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 9),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 10),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 11),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 12),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 13),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 14),
('Edificio A, Piso 2', '56 45 229 6000', 'biblioteca.temuco@inacap.cl', 'Lunes a Viernes 08:30 - 19:00', 1, 15);
